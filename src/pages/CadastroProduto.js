                            ...
                            <div className="p-4">
                                <Row>
                                    ...
                                    <Col sm={12} md={3} lg={3}>
                                        <Form.Row>
                                            <Form.Group as={Col} md={5} controlId="formGridEmail">
                                                <TextSmall>Preço:</TextSmall>
                                            </Form.Group>
                                            <Form.Group as={Col} md={7} controlId="formGridEmail">
                                                <Form.Control style={{ borderRadius: '1.5rem', border: '1px solid #fa7f79' }} onChange={onChangePrice} value={price} />
                                            </Form.Group>
                                        </Form.Row>
                                    </Col>
                                </Row>
                                    ...
                                    <Col sm={12} md={6} lg={6}>
                                        <Form.Row>
                                            <Form.Group as={Col} md={2} controlId="formGridEmail">
                                                <TextSmall>Desc:</TextSmall>
                                            </Form.Group>
                                            <Form.Group as={Col} md={8} controlId="formGridEmail">
                                                <Form.Control style={{ borderRadius: '1.5rem', border: '1px solid #fa7f79' }} onChange={onChangedescription} value={description} />
                                            </Form.Group>
                                        </Form.Row>
                                    </Col>
                                    <Col sm={12} md={2} lg={2}>
                                        <Form.Group as={Col} controlId="formGridEmail">
                                            <Form.Check type="checkbox" label="Bloqueado" />
                                        </Form.Group>
                                    </Col>
                                    <Col sm={12} md={3} lg={3}>
                                        <Form.Group as={Col} controlId="formGridEmail">
                                            <Form.Check type="checkbox" label="Sem Serviço" />
                                        </Form.Group>
                                    </Col>
                                </Row>
                                <Row>
                                    <Col sm={12} md={4} lg={4}>
                                        <Card style={{ borderRadius: '1.5rem', border: '1px solid #fa7f79' }}>
                                            <Text>
                                                <h5 className="text-center">Comemtarios</h5>
                                            </Text>
                                    ...
                                    <Col>
                                        <Card style={{ borderRadius: '1.5rem', border: '1px solid #fa7f79' }}>
                                            <Table responsive>
                                                <thead>
                                                    <tr>
                                                        <th style={{ color: '#fa7f79' }}>Código</th>
                                                        <th style={{ color: '#fa7f79' }}>Nome</th>
                                                        <th style={{ color: '#fa7f79' }}>Valor</th>
                                                        <th style={{ color: '#fa7f79' }}>Preço</th>
